...
void randomize_registers() {
    ...
    TIMER1_TBPMR_R = (unsigned int) rand();
...
void reuse_originals() {
    ...
    TIMER1_TBPMR_R = registers[19].original;
    TIMER1_TAILR_R = registers[20].original;
    TIMER1_TBILR_R = registers[21].original;
    TIMER1_TAMATCHR_R = registers[22].original;
    TIMER1_TBMATCHR_R = registers[23].original;

    // ADC0
    ADC0_ADCCC = registers[24].original;
    ADC0_ACTSS_R = registers[25].original;
    ADC0_EMUX_R = registers[26].original;
    ADC0_SSMUX0_R = registers[27].original;
    ADC0_SSCTL0_R = registers[28].original;

    ADC0_PSSI_R = registers[29].original;
    ADC0_RIS_R = registers[30].original;
    ADC0_ISC_R = registers[31].original;
    ADC0_SSFIFO0_R = registers[32].original;
}
...
void fill_originals() {
    ...
    registers[19].original = TIMER1_TBPMR_R;
    registers[20].original = TIMER1_TAILR_R;
    registers[21].original = TIMER1_TBILR_R;
    registers[22].original = TIMER1_TAMATCHR_R;
    registers[23].original = TIMER1_TBMATCHR_R;

    // ADC0
    registers[24].original = ADC0_ADCCC;
    registers[25].original = ADC0_ACTSS_R;
    registers[26].original = ADC0_EMUX_R;
    registers[27].original = ADC0_SSMUX0_R;
    registers[28].original = ADC0_SSCTL0_R;

    registers[29].original = ADC0_PSSI_R;
    registers[30].original = ADC0_RIS_R;
    registers[31].original = ADC0_ISC_R;
    registers[32].original = ADC0_SSFIFO0_R;
}
...
void fill_answers() {
    ...
    registers[19].answer = TIMER1_TBPMR_R;
    registers[20].answer = TIMER1_TAILR_R;
    registers[21].answer = TIMER1_TBILR_R;
    registers[22].answer = TIMER1_TAMATCHR_R;
    registers[23].answer = TIMER1_TBMATCHR_R;

    // ADC0
    registers[24].answer = ADC0_ADCCC;
    registers[25].answer = ADC0_ACTSS_R;
    registers[26].answer = ADC0_EMUX_R;
    registers[27].answer = ADC0_SSMUX0_R;
    registers[28].answer = ADC0_SSCTL0_R;

    registers[29].answer = ADC0_PSSI_R;
    registers[30].answer = ADC0_RIS_R;
    registers[31].answer = ADC0_ISC_R;
    registers[32].answer = ADC0_SSFIFO0_R;
}
...
void fill_tests() {
    ...
    registers[19].test = TIMER1_TBPMR_R;
    registers[20].test = TIMER1_TAILR_R;
    registers[21].test = TIMER1_TBILR_R;
    registers[22].test = TIMER1_TAMATCHR_R;
    registers[23].test = TIMER1_TBMATCHR_R;

    // ADC0
    registers[24].test = ADC0_ADCCC;
    registers[25].test = ADC0_ACTSS_R;
    registers[26].test = ADC0_EMUX_R;
    registers[27].test = ADC0_SSMUX0_R;
    registers[28].test = ADC0_SSCTL0_R;

    registers[29].test = ADC0_PSSI_R;
    registers[30].test = ADC0_RIS_R;
    registers[31].test = ADC0_ISC_R;
    registers[32].test = ADC0_SSFIFO0_R;
}
