...
class TestGrader(cgrader.CGrader):
    ...
    def tests(self):
        self.test_compile_file(["motors.c"], "main", points=1, add_c_file=[
            "/grade/tests/main.c",
        ...
        self.partial_credit_run("./main", exp_output=[
            "Sensor reading succeeded.",
            "Motor speed computation succeeded.",
            "Motor speed set succeeded."
        ], reject_output=[
            "Sensor reading failed.",
            "Motor speed computation failed.",
            "Motor speed set failed."
